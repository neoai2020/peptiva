      ...
      .then(({ data }) => {
        ...
        if (rows.length === 0) {
          setMessages([{
            id: 'welcome',
            sender: 'expert',
            text: `Hey ${user.firstName}! I'm your dedicated Peptiva support specialist. How can I help you today? You can ask me about your protocol, dosing, side effects, or anything else.`,
            time: 'Just now',
          }])
        } else {
