          ...
          <div style={{ background: '#fff', minHeight: 40 }}>
            ...
            <div style={{ padding: '14px 20px', borderTop: '1px solid #eee', display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontFamily: 'system-ui, sans-serif' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                <div style={{ width: 28, height: 28, borderRadius: 6, background: '#143F66', display: 'grid', placeItems: 'center', color: 'white', fontWeight: 700, fontSize: 12 }}>P</div>
                <span style={{ fontSize: 14, fontWeight: 600, color: '#0f172a' }}>Peptiva</span>
              </div>
